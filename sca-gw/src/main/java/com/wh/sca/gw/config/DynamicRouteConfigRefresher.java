...
@Component
public class DynamicRouteConfigRefresher implements ApplicationContextAware,ApplicationEventPublisherAware {

    private static final Logger logger = LoggerFactory.getLogger(DynamicRouteConfigRefresher.class);
    ...
    @ApolloConfigChangeListener(value = "sca-route-list.json")
    ...
    private void refreshGatewayRouteDefinition() {
        ...
        logger.info(this.gatewayProperties.getRoutes().toString());
